...
public class TestUriMatcher extends AndroidTestCase {
    ...
    private static final Uri TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR = WeatherContract.WeatherEntry.buildWeatherLocationWithDate(LOCATION_QUERY, TestUtilities.TEST_DATE);
