 ...
 */
package com.wyattbarnes.sunshine.data;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        // vnd.android.cursor.dir/com.wyattbarnes.sunshine/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry.CONTENT_TYPE",
                WeatherContract.WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://com.wyattbarnes.sunshine/weather/94074
        ...
        // content://com.wyattbarnes.sunshine/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherContract.WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.wyattbarnes.sunshine/weather/1419120000
        ...
        // vnd.android.cursor.dir/com.wyattbarnes.sunshine/location
    ...
    public void testBasicLocationQueries() {
        ...
        // Make sure we get the correct cursor out of the database
        TestUtilities.validateCursor("testBasicLocationQueries, " +
                "location query",
                locationCursor,
                testValues);
        ...
        if ( Build.VERSION.SDK_INT >= 19 ) {
            assertEquals("Error: Location Query did not properly set NotificationUri",
                    WeatherContract.LocationEntry.CONTENT_URI, locationCursor.getNotificationUri());
        }
    }
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        cal.setTimeInMillis(TestUtilities.TEST_DATE);
        ContentValues[] returnContentValues = new ContentValues[BULK_INSERT_RECORDS_TO_INSERT];

        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++) {
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm.ss.SSS'Z'");
            sdf.setTimeZone(TimeZone.getTimeZone("UTC"));
            Log.d(LOG_TAG, sdf.format(cal.getTime()));
    ...
    public void testBulkInsert() {
        ...
        //int manInsertCout = 0;
        //for (ContentValues value : bulkInsertContentValues) {
        //    long rowId = ContentUris.parseId(mContext.getContentResolver().insert(WeatherContract.WeatherEntry.CONTENT_URI, value));
        //    if (rowId != -1) {
        //        manInsertCout++;
        //    }
        //}
